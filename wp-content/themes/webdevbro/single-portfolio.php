...
?>
  <div class="metabox metabox--position-up metabox--with-home-link">
    <p><a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('portfolio'); ?>"><i class="fab fa-buffer"></i> Portfolio Archive </a> <span class="metabox__main"><?php the_title(); ?></span></p>
  </div>
